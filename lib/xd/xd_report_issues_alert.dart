...
class XDReportIssuesAlert extends StatelessWidget {
            ...
            child: Text.rich(
              TextSpan(
                ...
                children: [
                  TextSpan(
                    text:
                        'Please visit National Headquarters to report issues concerning service.\nFor complaints concerning the app, please reach us at\n',
                    style: TextStyle(
                      fontWeight: FontWeight.w500,
                    ),
                  ),
                  TextSpan(
                    text: 'enquiry@911gh.com',
                    style: TextStyle(
                      color: const Color(0xff7fb6f0),
                      fontWeight: FontWeight.w500,
                    ),
                  ),
                ],
