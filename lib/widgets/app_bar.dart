            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                    Icon(Icons.local_fire_department, color: red, size: 30,),
                    SizedBox(width: 2),
                    Text("192", style: titleRed),
                  ],
                ),
              ],
            ),
...
class AppBarPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path2_fill.color = Color(0xffffffff).withOpacity(1.0);
    ...
    canvas.drawShadow(path2, blue, 5, true);
